                        ...
                        <Accordion defaultActiveKey="0">
                            ...
                            <Card className="card-faqs">
                                <Accordion.Toggle
                                    ...
                                    className="card-faqs btn-sol"
                                >
                                    Menambahkan indikator untuk pertanian
                </Accordion.Toggle>
                                <Accordion.Collapse eventKey="1">
                                    <Card.Body>
                                        1. Indikator dipilih di saat Set Up awal masuk sistem Evomo
<br />2. Profil > Pengaturan > Indikator
                                    </Card.Body>
                                </Accordion.Collapse>
                            </Card>
                            <hr />
                            ...
                            <Card className="card-faqs">
                                <Accordion.Toggle
                                    ...
                                    className="card-faqs btn-sol"
                                >
                                    Cara trial produk Evo Agriculture
                </Accordion.Toggle>

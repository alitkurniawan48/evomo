...
const SectionTwo = () =>{
    ...
    return(
      <div>
      <Container fluid className="partition section-pad-2 center-desc">
        ...
        <Row className="d-flex justify-content-center align-items-center">
          <Col><h2 className="txt-2 center-desc-text">Apapun bisnismu,<br/>Evomo dapat membantumu</h2></Col>
        </Row>
 
        <Row style={{display:'flex', justifyContent:'center'}}>
          <Col md={{ span: 9 }}><h5 className="txt-3 center-desc-text">Aplikasi <b>Monitoring Berbasis Kondisi</b> yang memberikan Anda informasi mengenai kondisi yang ingin anda pantau berdasarkan indikator yang Anda tentukan baik berupa suhu, kelembaban, tekanan udara, pemakaian listrik, jumlah debit air, integrasi cctv, dll. Evomo menjadi solusi Anda dalam memonitoring proses pertanian, perikanan, peternakan, pembangunan dan area publik.</h5></Col>
        </Row>
      </Container>

        ...
        <div className="row">
          ...
          <div className="col no-flex" >
            <ul className="list-unstyled">
              ...
              <a href="/cara-kerja/"><li className="li-fo">Cara Kerja</li></a>
              <a href="/fitur/"><li className="li-fo">Fitur</li></a>
              <a href="https://wa.me/6282211776239"><li className="li-fo">Hubungi Kami</li></a>
            </ul>
          </div>
          {/* Col 2 */}
          <div className="col no-flex">
